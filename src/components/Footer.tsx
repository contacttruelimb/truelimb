          ...
          <div className="lg:col-span-1">
            <a href="#home" className="flex items-center gap-3 mb-6">
              <img 
                src={logo} 
                alt="Truelimb" 
                className="h-12 w-auto object-contain bg-primary-foreground rounded-lg p-1"
              />
              <div className="flex flex-col">
                <span className="font-display font-bold text-xl text-primary-foreground">
                  True<span className="text-accent">limb</span>
                </span>
                <span className="text-[9px] text-primary-foreground/60 tracking-widest uppercase">Easing Every Step</span>
              </div>
            </a>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-primary-foreground/70 text-sm">
                  ...
                  Near Orchid Hospital, Lalpur,<br />
                  834001, Ranchi, Jharkhand
                </span>
              </li>
              <li className="flex items-center gap-3">
                <Phone className="w-5 h-5 text-accent flex-shrink-0" />
                <a href="tel:+919288511995" className="text-primary-foreground/70 hover:text-accent transition-colors text-sm">
                  +91 9288511995
                </a>
              </li>
              <li className="flex items-center gap-3">
                <Mail className="w-5 h-5 text-accent flex-shrink-0" />
                <a href="mailto:contact.truelimb@gmail.com" className="text-primary-foreground/70 hover:text-accent transition-colors text-sm">
                  contact.truelimb@gmail.com
                </a>
              </li>
            </ul>
          </div>
